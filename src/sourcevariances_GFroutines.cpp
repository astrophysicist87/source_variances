...
void SourceVariances::Get_GF_HBTradii(FO_surf* FOsurf_ptr, int folderindex)
{
...
void SourceVariances::Cal_correlationfunction_1D(int iKT, int iKphi)
{
   if(fabs(K_y) > 1e-16)
   {
       cout<<"SourceVariances:: not support for y not equals 0 yet!" << endl;
       return;
   }
...
double SourceVariances::Emission_function(double p0, double pT, double pphi, double pz, FO_surf * FOcell_ptr, int local_pid)
{
...
void SourceVariances::Cal_correlationfunction_3D(int iKT, int iKphi)
{
   if(fabs(K_y) > 1e-16)
   {
...
int SourceVariances::Read_correlationfunction_3D(int iKT, int iKphi)
{
   if(fabs(K_y) > 1e-16)
   {
       //cout<<"not support for y not equals 0 yet!" << endl;
...
int SourceVariances::Read_correlationfunction_1D(int iKT, int iKphi)
{
   if(fabs(K_y) > 1e-16)
   {
       //cout<<"not support for y not equals 0 yet!" << endl;
...
void SourceVariances::Fit_Correlationfunction1D(char osl_switch, int iKT, int iKphi)
{
...
void SourceVariances::Fit_Correlationfunction3D(int iKT, int iKphi)
{
...
void SourceVariances::Fit_Correlationfunction3D_withlambda(int iKT, int iKphi)
{
  const size_t data_length = qnpts*qnpts*qnpts;  // # of points
...
int SourceVariances::print_fit_state_1D (size_t iteration, gsl_multifit_fdfsolver * solver_ptr)
{
  cout.setf (ios::fixed, ios::floatfield);	// output in fixed format
...
//*********************************************************************
//  Simple function to print results of each iteration in nice format
int SourceVariances::print_fit_state_3D (size_t iteration, gsl_multifit_fdfsolver * solver_ptr)
{
  cout.setf (ios::fixed, ios::floatfield);	// output in fixed format
  cout.precision (5);		// digits in doubles
...
//  Simple function to print results of each iteration in nice format
int SourceVariances::print_fit_state_3D_withlambda (size_t iteration, gsl_multifit_fdfsolver * solver_ptr)
{
  cout.setf (ios::fixed, ios::floatfield);	// output in fixed format
  cout.precision (5);		// digits in doubles
...
inline double SourceVariances::get_fit_results(int i, gsl_multifit_fdfsolver * solver_ptr)
{
...
inline double SourceVariances::get_fit_err (int i, gsl_matrix * covariance_ptr)
{
